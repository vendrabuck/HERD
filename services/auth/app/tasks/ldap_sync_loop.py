...
from app.config import MIN_LDAP_SYNC_INTERVAL_SECONDS, settings
...
# pass sub-second intervals directly. Aliases the constant in app.config so
# the stale-run clamp there (effective_ldap_sync_run_stale_seconds, which
# floors at twice this interval) and this clamp cannot drift apart.
_MIN_PRODUCTION_INTERVAL_SECONDS = MIN_LDAP_SYNC_INTERVAL_SECONDS
